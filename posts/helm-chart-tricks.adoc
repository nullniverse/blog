...
Modularity and flow control is a must in order to avoid complexity and foster readability.

Let's go to the example. 

Below is an Ingress recipe for k8s.
